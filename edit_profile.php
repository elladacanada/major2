...
<br>
                <div class=form-row>
                     <div class="col">
                        <input type="text"  name="address" placeholder="Aaddress" value="<?php echo $user_row['address']; ?>" class="form-control">
                    </div>
                </div>
<br>
                <div class=form-row>
                    <div class="col">
                        <input type="text"  name="address2" placeholder="Address" value="<?php echo $user_row['address2']; ?>" class="form-control">
                    </div>
                </div>
<br>
                <div class=form-row>
                    <div class="col">
                        <input type="text"  name="city" placeholder="City" value="<?php echo $user_row["city"]; ?>" class="form-control">
                    </div>
              
                    <div class="col">
                        <input type="text"  name="postal_code" placeholder="Postal Code" value="<?php echo $user_row["postal_code"]; ?>" class="form-control">
                    </div>
                </div>
<br>
                <div class=form-row>
                    <div class="col">
                        <input type="email"  name="email" placeholder="Email" value="<?php echo $user_row['email']; ?>" class="form-control">
                    </div>
                </div>
<br>
                <div class="form-row">
        ...
        ?>
            ...
            <div class="col text-right">
                <button type="submit" name="action" value="delete" class="btn btn-text btn-outline-danger">Delete Account</button>
                <button type="submit" tabindex="3" name="action" value="update" class="btn btn-text btn-primary">Update Account</button>
            </div>
